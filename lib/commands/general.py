...
async def addbot(cmd):
    em = discord.Embed(title="Invite me to your server", description="Invitation link: https://discord.com/api/oauth2/authorize?client_id=848178172536946708&permissions=2214979664&scope=bot", color=0x2ECC71)
