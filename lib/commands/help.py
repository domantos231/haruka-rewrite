...
class CustomHelpCommand(commands.MinimalHelpCommand):
    ...
    async def send_group_help(self, group: commands.Group):
        ...
        em.set_author(name = f"{self.context.author.name}, this is an instruction for {group.qualified_name}!", icon_url = self.context.author.avatar.url if self.context.author.avatar else discord.Embed.Empty)
        await self.context.send(embed = em)
